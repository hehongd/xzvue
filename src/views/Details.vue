    ...
    <div class="container mb-5">
      <div class="row pr-3">
        <div id="preview" class="col pr-0">
          <div
            style="width: 352px"
            class="card bg-transparent mr-5 position-absolute"
          >
            <img
              class="card-img-top"
              src="../assets/img/product_detail/product_detail_img15 (1).png"
              alt="Card image cap"
            />
            ...
            <div
              ...
              style="
                background-image: url(/img/product/lg/57e3b072N661cd00d.jpg);
              "
            ></div>
            <div class="card-body p-0 text-center">
              <img
                src="../assets/img/product_detail/product_detail_img2.jpg"
              ...
              <img
                src="../assets/img/product_detail/product_detail_img1.jpg"
        ...
        <div id="details" class="col pl-0">
          ...
          <div>
            ...
            <div class="float-left w-75">
              <router-link v-for="sp,i of specs" :key="i" class="btn btn-sm btn-outline-secondary" :class="{ active: lid==sp.lid }" :to="`/details/${sp.lid}`">{{sp.spec}}</router-link>
            </div>
          ...
          <li class="float-left">
            <div class="card mb-1 p-4 border-0 bg-transparent box-shadow">
              <img
                ...
                src="../assets/img/product_detail/product_detail_1.png"
          ...
          <li class="float-left">
            <div class="card mb-1 p-4 border-0 bg-transparent box-shadow">
              <img
                ...
                data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail"
                alt="Thumbnail [100%x225]"
                src="../assets/img/product_detail/product_detail_2.png"
                data-holder-rendered="true"
              />
              <div class="card-body p-0">
                <p class="card-text text-center small">
          ...
          <li class="float-left">
            <div class="card mb-1 p-4 border-0 bg-transparent box-shadow">
              <img
                ...
                data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail"
                alt="Thumbnail [100%x225]"
                src="../assets/img/product_detail/product_detail_3.png"
                data-holder-rendered="true"
              />
              <div class="card-body p-0">
                <p class="card-text text-center small">
          ...
          <li class="float-left">
            <div class="card mb-1 p-4 border-0 bg-transparent box-shadow">
              <img
                ...
                data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail"
                alt="Thumbnail [100%x225]"
                src="../assets/img/product_detail/product_detail_4.png"
                data-holder-rendered="true"
              />
              <div class="card-body p-0">
                <p class="card-text text-center small">
          ...
          <div>
            ...
            <div>
              <div class="pl-3 small">
                技术规格请前往 www.apple.com/cn/macbook-air/specs.html
                查看完整内容。
              </div>
            </div>
          </div>
...
export default {
  //要接地址栏中的参数值: 
  props:["lid"],
  //因为界面上需要一个商品对象和两个数组(规格列表和图片列表)
  data(){
    return {
      product:{ price:0 },//商品对象
      pics:[],//图片列表
      specs:[]//规格参数对象列表
    }
  },
  ...
  watch:{
    //本例中:希望地址栏参数值一变，自动自行一次axios请求
    //地址栏的参数值会自动交给props中的lid
    //所以应该监控props中的lid
    lid(){
      this.loadPage();
    }
