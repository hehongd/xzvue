      ...
      <h3 class="pb-3">
        <nav class="navbar navbar-light border-bottom border-secondary pb-0 mb-2">
          <a class="navbar-brand" href="#">
            <img src="../assets//img/index/computer_icon.png" class="d-inline-block align-top" alt="">
            首页推荐 / 1F
          </a>
        </nav>
        <div class="row mb-2">
        ...
        <div class="row mb-2">
          ...
          <div class="col-md-7 pl-0">
            <div class="row pr-3">
              <div class="col-md-4 p-0 pl-2" v-for="p,i of others" :key="p.pid">
                <div class="card border-0 text-center">
                  ...
                  <div class="card-body p-0 pr-1 pl-1">
                    ...
                    <router-link class="btn btn-sm btn-primary" :to="`/details/${p.href.split('=')[1]}`">查看详情</router-link>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row mb-2">
          <div class="col-md-7">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              ...
              <img class="card-img-right flex-auto d-none d-md-block" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" src="../assets/img/index/study_computer_img1.png" data-holder-rendered="true">
            </div>
          </div>
          <div class="col-md-5">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              ...
              <img class="card-img-right flex-auto d-none d-md-block mt-5" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" src="../assets/img/index/study_computer_img2.png" data-holder-rendered="true">
            </div>
          </div>
        </div>
        <div class="row mb-2">
          <div class="col-md-5">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              ...
              <img class="card-img-right flex-auto d-none d-md-block mt-5" data-src="holder.js/200x250?theme=thumb" alt="Thumbnail [200x250]" src="../assets/img/index/study_computer_img3.png" data-holder-rendered="true">
            </div>
          </div>
          <div class="col-md-7">
            <div class="row pr-3">
              <div class="col-md-4 p-0 pl-2">
                <div class="card border-0 text-center">
                  <img class="card-img-top" src="../assets/img/index/study_computer_img4.png" alt="Card image cap">
                  <div class="card-body p-0 pr-1 pl-1">
              ...
              <div class="col-md-4 p-0 pl-2">
                <div class="card border-0 text-center">
                  <img class="card-img-top" src="../assets/img/index/study_computer_img5.png" alt="Card image cap">
                  <div class="card-body p-0 pr-1 pl-1">
              ...
              <div class="col-md-4 p-0 pl-2">
                <div class="card border-0 text-center">
                  <img class="card-img-top" src="../assets/img/index/study_computer_img3.png" alt="Card image cap">
                  <div class="card-body p-0 pr-1 pl-1">
  ...
  mounted(){
    this.axios.get("/index").then(result=>{
      ...
      result.data.forEach(x => {
        return x.pic = require('../assets/'+ x.pic)
      });

      // this.p1=result.data[0];
      // this.p2=result.data[1];
      // this.p3=result.data[2];
      // this.others=result.data.slice(3);//选择从3位置到结尾的所有剩余商品
      //复习数组解构
